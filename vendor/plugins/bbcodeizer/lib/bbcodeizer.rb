module BBCodeizer  
  class << self
    ...
    Tags = {
      ...
      :revver                => [ /\[revver\](.+?)revver.com\/watch\/(.+?)\[\/revver\]/i, '<script src="http://flash.revver.com/player/1.0/player.js?mediaId:\2;affiliateId:0;height:392;width:480;" type="text/javascript"></script>' ]
    }
    ...
    TagList = [ :bold, :italic, :underline, :email_with_name, :email_sans_name, 
                ...
                :superdeluxe, :comedycentral, :revver ]
