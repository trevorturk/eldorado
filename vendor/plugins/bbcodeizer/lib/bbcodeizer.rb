module BBCodeizer  
  class << self
    ...
    Tags = {
      ...
      :hulu                  => [ /\[hulu\](.+?)hulu.com\/watch\/(.+?)\/(.+?)\[\/hulu\]/i, '<object width="520" height="295"><param name="movie" value="http://www.hulu.com/embed/\2"></param><embed src="http://www.hulu.com/embed/\2" type="application/x-shockwave-flash"  width="520" height="295"></embed></object>' ],
