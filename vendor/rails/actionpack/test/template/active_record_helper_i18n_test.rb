...
<<<<<<< HEAD:vendor/rails/actionpack/test/template/active_record_helper_i18n_test.rb
...
>>>>>>> i18n:vendor/rails/actionpack/test/template/active_record_helper_i18n_test.rb
    end
