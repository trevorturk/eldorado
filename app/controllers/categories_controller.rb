class CategoriesController < ApplicationController
  ...
  def show
    ...
    @topics = Topic.paginate(:page => params[:page], :include => [:user, :forum, :last_poster, :viewings], :order => 'topics.last_post_at desc', :conditions => ["forum_id in (?)", @forums.collect(&:id)])
